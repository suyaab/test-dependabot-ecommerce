...
export const ageConsentSchema = z
  .boolean()
  .refine((value) => value, "Required field");
export const insulinConsentSchema = z
  .boolean()
  .refine((value) => value, "Required field");

export const diabetesConsentSchema = z
  .boolean()
  .refine((value) => value, "Required field");

export const medicalActionConsentSchema = z
  .boolean()
  .refine((value) => value, "Required field");
...
export const customerContactInfoSchema = z.object({
  ...
  ageConsent: ageConsentSchema,
  insulinConsent: insulinConsentSchema,
  diabetesConsent: diabetesConsentSchema,
  medicalActionConsent: medicalActionConsentSchema,
});
