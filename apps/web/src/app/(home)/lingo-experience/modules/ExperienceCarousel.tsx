...
export default async function ExperienceCarousel() {
  const cms = ServiceLocator.getCMS();

  const { title, items } = await cms.getLECarouselContent();

  return (
    <section data-analytics-location={LocationAttributes.HOW_IT_WORKS}>
