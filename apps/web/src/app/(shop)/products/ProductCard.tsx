...
export default function ProductCard({
  ...
  return (
    <Card
      ...
      dataAnalyticsLocation={LocationAttributes.SKU_HIGHLIGHT}
    ...
    >
      ...
      <div className="flex grow basis-1/2 flex-row-reverse flex-wrap items-center gap-x-2">
        ...
        {savingDetails?.pdpCardTag != null && (
          <div className="rounded bg-blue px-2 py-1 font-semibold text-xs text-white">
            {savingDetails?.pdpCardTag}
          </div>
        )}
      </div>
