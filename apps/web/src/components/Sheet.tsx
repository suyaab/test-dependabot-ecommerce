...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="data-[state=open]:bg-secondary absolute right-[var(--sideGap)] top-5 -mr-2 disabled:pointer-events-none lg:right-[var(--sideGapDesktop)]">
