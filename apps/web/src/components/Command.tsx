...
/**
 * A custom wrapper component for the CommandPrimitive component.
 * It forwards the ref to the CommandPrimitive component and accepts additional props.
 *
 * @component
 * @example
 * ```tsx
 ...
 * ```
 *
 * @param {object} props - The props for the Command component.
 * @param {string} [props.className] - The optional class name for the Command component.
 * @param {React.Ref} ref - The ref to be forwarded to the CommandPrimitive component.
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3">
    <MagnifyingIcon className="mr-2 h-4 w-4 shrink-0 opacity-50" />
