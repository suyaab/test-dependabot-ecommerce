...
import SampleConfirmationCookie from "./SampleConfirmationCookie";
...
export default async function OrderConfirmation({
  ...
  const cms = CMSServiceLocator.getCMS();
  const { header, whatsNext, confirmation, shipping, footer, failedToFetch } =
  ...
  const productsData = await cms.getPromotionalProductCardsContent(orderSkus);
    ...
    <>
      ...
      <div className="grid-container">
        ...
        <section className="col-span-full lg:col-span-10 lg:col-start-2">
          ...
          <h6 className="mb-4 font-medium text-lg lg:mt-24">{footer.title}</h6>
          <div
